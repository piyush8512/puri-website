...
function Events() {
  return (
    <div className=" md:flex hidden relative h-[100vh] md:h-[130vh]  flex-col md:flex-row md:justify-evenly items-center bg-cover bg-right md:bg-center bg-no-repeat event-bg w-full  px-4  gap-5 md:gap-0">
      {/* Heading */}
