...
function Speakers() {
  ...
  return (
    <div className=" md:flex hidden speakers-bg bg-no-repeat bg-cover bg-center min-h-[120vh] md:h-[140vh]  flex-col md:flex-row justify-center items-center relative overflow-hidden px-4 sm:px-6 lg:px-8 py-12">
