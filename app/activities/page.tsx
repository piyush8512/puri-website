...
// const page = () => {
//   return (
//     <div className="relative pt-15 inset-0 overflow-x-hidden items-center justify-center">
//       {/* header */}
//       <div className="hidden hero-bg bg-center bg-cover bg-no-repeat min-h-[30vh] h-[30vh] md:flex md:flex-col items-center justify-start relative">
//         <Image
...
//         Features
//       </h1>
//       <p className=" text-[10px] md:text-xl lg:text-xl xl:text-xl  text-center mt-10 md:mt-15 lg:mt-12 mb-0 lg:mb-20 md:mx-60 mx-10 ">
//         The Puri Literary Festival 2025 is dedicated to creating an inclusive
//         and accessible environment where people from all backgrounds, abilities,
//         and socio-economic standings can come together to celebrate literature,
...
//       {/* yellowsecondsection */}
//       <div className="relative w-full md:h-[130vh] h-[100vh]  flex md:items-center justify-center">
//   {/* White top overlay - now with highest z-index */}
//   <div className="absolute bottom-0 inset-0 z-50">
//     <Image 
//       src="/activities/whitetop.png" 
//       alt="White Top Overlay" 
//       layout="fill" 
//       objectFit="contain" 
...
//   {/* Content */}
//   <div className="relative z-10 px-2 md:px-8 lg:px-16  py-0 md:py-12">
//     <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-12 px-16 mt-28 md:mt-0">
//       {/* Heading */}
...
//     />
//   </div>
//   <div className="absolute -top-10 -left-3 md:-top-80 md:-left-20 sm:-left-10 -z-10 w-22 sm:w-36 md:w-48 lg:w-86">
//     <Image
...
//     />
//   </div>  
//   <div className="absolute  -top-2 -right-0 md:-top-30 md:-right-0 sm:-right-0 -z-110 w-24 sm:w-36 md:w-48 lg:w-86">
//     <Image
...
// {/* whitesection */}
// <div className="relative w-full md:h-[70vh] flex items-center justify-center">
//   <div className="container mx-auto px-2 text-center">
//     <div className="max-w-4xl mx-auto md:px-0 px-8 ">
//       <div className="max-w-4xl mx-auto flex ">
//       <Image src='leftgoldenflag.svg' alt="Golden Flag" width={50} height={200} className="mx-auto mb-4" />
//       <h1 className="text-xl md:text-3xl lg:text-4xl font-bold text-[#2F3082] mb-6">
//         Inaugural PLF <br/> 
//          Book of the Year Awards 2024
//       </h1>
//       <Image src='rightgoldenflag.svg' alt="Golden Flag" width={50} height={200} className="mx-auto mb-4" />
...
// {/* yellowsection */}
// <div className="relative w-full md:h-[130vh] h-[100vh]  flex items-center justify-center">
// <div className="absolute inset-0 z-0">
//     <Image
...
//   <div className="relative z-10 px-0 md:px-8 lg:px-24 ">
//     <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-14 md:px-20 px-14">
//       {/* Heading */}
//       <div className="w-full lg:w-1/3 text-center lg:text-center">
...
//       {/* Paragraph */}
//       <div className="w-full lg:w-2/3 text-xs md:text-2xl lg:text-2xl text-gray-700 text-justify md:leading-relaxed md:px-0 px-6">
//         <p>
//         Amidst the rhythm of literary discussions and the rustle of pages turning, the special stalls showcasing the crème de la crème of Indian publishing will offer an oasis for every book lover. Here, the leading publishing houses of India will unfold their treasure troves of stories, spanning the breadth of genres and realms, from timeless classics to cutting-edge new releases.
//         </p>
//       </div>
//     </div>
//   </div>
//   <div className="absolute top-16 md:-top-20 center z-20 w-18 sm:w-36 md:w-48 lg:w-46">
//     <Image
...
//     />
//   </div>
//   <div className="absolute top-20 md:-top-40 -left-6 sm:right-8 -z-10 w-18 sm:w-36 md:w-48 lg:w-46">
//     <Image
...
//     />
//   </div>
//   <div className="absolute md:top-5 top-30 right-0 sm:right-8 z-20 w-24 sm:w-36 md:w-48 lg:w-86">
//     <Image
...
//     />
//   </div>
//   <div className="absolute bottom-30 md:bottom-24 left-0 sm:left-0 z-20 w-24 sm:w-36 md:w-48 lg:w-56">
//     <Image
...
//     />
//   </div>
//   <div className="absolute md:bottom-6 bottom-35 right-0 sm:right-8 z-20 w-20 sm:w-36 md:w-48 lg:w-56">
//     <Image
...
//       width={150}
//       height={200}
//       className="absolute -top-27  -left-24"
//     />
//     <div className="bg-[#303182] rounded-full flex items-center justify-center px-8 py-3">
//       <p className="text-[#FFFCF5] text-lg md:text-xl lg:text-2xl font-bold font-leckerli">
//         Download Brochure
//       </p>
//     </div>
//   </div>
...
const page = () => {
  return (
    <div className="relative pt-15 inset-0 overflow-x-hidden items-center justify-center w-full">
      {/* header */}
      ...
      <div className="w-full px-4 md:px-0">
        <p className="text-[10px] md:text-xl lg:text-xl xl:text-xl text-center mt-10 md:mt-15 lg:mt-12 mb-0 lg:mb-20 md:mx-60 mx-4">
          The Puri Literary Festival 2025 is dedicated to creating an inclusive
          and accessible environment where people from all backgrounds, abilities,
          and socio-economic standings can come together to celebrate literature,
          culture, and heritage. We believe that these elements should be shared
      ...
      <div className="relative w-full md:h-[130vh] h-[100vh] flex md:items-center justify-center">
        {/* White top overlay */}
        <div className="absolute bottom-0 inset-0 z-50 w-full">
          <Image 
            src="/activities/whitetop.png" 
            alt="White Top Overlay" 
            layout="fill" 
        ...
        <div className="relative z-10 px-2 md:px-8 lg:px-16 py-0 md:py-12 w-full">
          <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-12 px-4 md:px-16 mt-28 md:mt-0 w-full">
            {/* Heading */}
            <div className="w-full lg:w-1/3 text-center lg:text-center">
              <h1 className="text-xl md:text-xl lg:text-3xl font-bold text-[#D72327] md:mb-0 md:my-0 lg:mb-0">
                Tribal Stalls &
      ...
      {/* whitesection */}
      <div className="relative w-full md:h-[70vh] flex items-center justify-center py-10 md:py-0">
      ...
      <div className="relative w-full md:h-[130vh] h-[100vh] flex items-center justify-center">
        ...
        {/* Illustrations */}
        <div className="absolute top-16 md:-top-20 left-1/2 transform -translate-x-1/2 z-20 w-18 sm:w-36 md:w-48 lg:w-46">
          <Image
            src="/activities/trophy.svg"
