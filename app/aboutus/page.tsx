...
<div className="relative w-full  flex items-center justify-center">
      ...
      {/* Content Wrapper */}
      <div className="relative w-full max-w-7xl min-h-screen px-6 md:px-8 lg:px-4 flex flex-col md:flex-row items-center md:items-start gap-8 my-2 py-6">
        {/* Left Section */}
        <div className="w-full md:w-1/3 flex flex-col items-start text-left mt-70" >
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#FFC40C] font-leckerli justify-center">Philosophy</h1>
        ...
        <div className="w-full md:w-2/3 text-white pt-24">
          <p className="text-base md:text-[17px] leading-relaxed">
            Set against the serene backdrop of Puri, a city steeped in spirituality and heritage,
            the Puri Literary Festival 2025 celebrates India’s enduring cultural legacy and its
            progressive aspirations. Rooted in the philosophy of Samavāya—the harmonious coexistence
            of tradition and modernity—the festival seeks to inspire a holistic dialogue that
            bridges India’s ancient wisdom with its contemporary ambitions. The Puri Literary
            Festival 2025 is an ode to the eternal cyclicity of time and knowledge, a harmonious
            dialogue between the past and the future, inspired by the sacred wheels of the Konark
            Sun Temple and the divine Ratha of Lord Jagannath. These wheels symbolize the perpetual
            motion of life, the ceaseless journey of humanity through epochs, and the profound
            interplay of tradition and transformation. Key objectives of the session are to reaffirm
            Puri’s spiritual and cultural legacy and to foster global dialogue with an indigenous
            lens. At its core, the festival embraces the belief that India’s timeless wisdom and
            artistic heritage serve not as relics of the past but as guiding lights for the future.
            It is through this lens that the festival seeks to explore how the nation can ascend to
            new pinnacles in art, architecture, literature, and economic development while remaining
            deeply rooted in its cultural ethos. The festival’s impact will extend far beyond the
            venue, with an outreach program spanning every district of Odisha. Events including
            heritage walks, folk art performances, and discussions on Odia literature will ensure
            grassroots participation, rekindling pride in Odisha’s traditions. In schools and
            colleges, workshops and storytelling sessions will inspire the youth, while expert-led
            dialogues on environmental sustainability, digital literacy, and cultural preservation.
            The culmination of these efforts will be a “Vision for Tomorrow” document, encapsulating
            insights to guide future policy and cultural initiatives. The Puri Literary Festival
            2025 promises to be an enriching experience that echoes throughout the state, inspiring
            a deeper connection with India’s cultural roots while embracing a modern,
...
{/* text */}
    <div className="flex items-center justify-center min-h-[80vh] text-center flex-col">
            ...
            >
              ...
              <div className="bg-white p-4 shadow-lg w-64 md:w-72">
                ...
                <div className="text-center pb-2">
                  <p className="text-xl font-serif font-medium">{director.name}</p>
                  <p className="text-xl font-serif font-medium">{director.surname}</p>
                </div>
              </div>
            </div>
          ))}
    ...
    {team.length > 0 && (
      <>
        ...
        {team.map((_, i, arr) => {
          if (i % 5 === 0) {
            return (
              <div key={`row-${i}`} className="grid grid-cols-1 md:grid-cols-3 gap-8 justify-center">
                {arr.slice(i, i + 3).map((team, index) => (
                  ...
                  >
                    <div className="bg-white p-4 shadow-lg w-64 md:w-72">
                      ...
                      <div className="text-center pb-2">
                        <p className="text-xl font-serif font-medium">{team.name}</p>
                        <p className="text-xl font-serif font-medium">{team.surname}</p>
                      </div>
                    </div>
                  </div>
                ))}
            ...
            return (
              <div key={`row-${i}`} className="grid grid-cols-1 md:grid-cols-2 gap-8 justify-center">
